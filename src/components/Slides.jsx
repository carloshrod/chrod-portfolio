	...
	<div key={index} className='slide-container'>
		...
		<div className='slide-links'>
			<div className='col link frtd'>
				<a href={slide.link1.url} target='_blank' rel='noopener noreferrer'>
			...
			{slide.link2 && (
				<div className='col link project'>
					<a href={slide.link2.url} target='_blank' rel='noopener noreferrer'>
			...
			{slide.link3 && (
				<div className='col link bckd'>
					<a href={slide.link3.url} target='_blank' rel='noopener noreferrer'>
						<i className={'bx bxl-github bx-md bx-tada-hover'} />
					</a>
