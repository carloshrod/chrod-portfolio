export const projectsInfo = [
    {
        ...
        description: "Hooks, Context API, React-Router, Bootstrap, Fetch API, JWT-decode, Bcryptjs, Chart.js, Express, MongoDb, Mongoose, Cloudinary, Jsonwebtoken, Nodemailer.",
        link1: {
            label: "Frontend",
        ...
        link2: {
            label: "Deploy",
            url: "https://gestion-catastral.netlify.app",
            icon: "bx bxl-netlify bx-md bx-tada-hover"
        },
        link3: {
            label: "Backend",
            url: "https://github.com/carloshrod/predial-backend"
        }
    },
    {
        ...
        link2: {
            label: "Deploy",
            url: "https://chrod-movies.netlify.app/",
            icon: "bx bxl-netlify bx-md bx-tada-hover"
        },
        link3: {
            label: "Backend",
            url: "https://github.com/carloshrod/movies-backend"
        }
    },
    {
